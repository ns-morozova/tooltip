...
;// CONCATENATED MODULE: ./src/js/PopoverTitle.js
...
var PopoverTitle = /*#__PURE__*/function () {
  ...
  return _createClass(PopoverTitle, [{
    ...
    key: "eventClick",
    value: function eventClick(event) {
      event.preventDefault();
      this.togglePopover(event.currentTarget);
    }
  }, {
    key: "togglePopover",
    value: function togglePopover(element) {
      this.popover.classList.toggle('hidden-popover');
      if (this.popover.classList.contains('hidden-popover')) {
        return;
      }
      var coordEl = element.getBoundingClientRect();
      console.log(coordEl);
      var coordPop = this.popover.getBoundingClientRect();
      var popoverTopY = coordEl.top - coordPop.height - 8;
      console.log(popoverTopY);
      var popoverTopX = coordEl.left + coordEl.width / 2 - coordPop.width / 2;
